  ...
  const [reviews, setReviews] = useState([
    {
      ...
      title: "Product name",
      description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque vitae tincidunt augue, at porta sapien. Suspendisse ac finibus tellus, non dapibus nibh. Nulla aliquam, odio ultricies aliquet pretium, lectus velit lacinia diam, dignissim egestas tortor nisi sagittis nunc.",
      rating: "4",
    },
    {
      name: "John Deo",
    ...
    <>
      ...
      <div className={`container mx-auto ${raleway.className}`}>
        <div className="flex flex-row justify-center md:flex-row">
          <div className="mb-4 w-full p-4 sm:w-full md:mb-0 md:mr-4 md:w-auto md:flex-shrink-0">
            <CustomSwiper images={images} />
          </div>
          <div className="w-full p-4 md:w-auto lg:w-1/2">
            <form onSubmit={(e) => handleSubmit(e)} className="p-4">
              ...
              <p className="py-4 text-5xl font-bold">
                {products.length > 0 &&
                  `${products[0]?.product.title} ${products[0]?.product?.type}`}
              </p>
              <p className="border-b py-2 text-2xl font-semibold text-[#636363]">
                ${products.length > 0 && products[0]?.product.price}
              </p>
                  ...
                  {sizeOptions.map((size, index) => (
                    <button
                      ...
                      className={`h-10 w-10 rounded-full border text-sm font-medium  ${
                        selectedSize === size ? "border border-white text-white" : "text-gray-400"
                      }`}
              ...
              <div className=" border-b py-5">
                ...
                <div>
                  <div className="inline-flex   py-5 sm:space-x-2 md:space-x-2" role="group">
                  ...
                  <div className="gap-28 sm:flex">
                    <div className="col-span-12 flex flex-row  max-lg:hidden max-lg:pt-6 lg:col-span-2 lg:flex-col lg:items-center ">
                      ...
                      <p className="flex  whitespace-nowrap text-lg font-medium leading-8 text-gray-400 lg:text-center">
                        <button
                          className="mb-2 max-h-[30px] max-w-[136px] border-gray-200  bg-[#121212] px-5  text-sm font-medium text-white  
