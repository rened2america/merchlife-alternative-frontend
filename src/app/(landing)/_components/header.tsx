            ...
            <div className="relative bg-[#F3F3F3] shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg">
              <div className="mx-auto max-w-md">
                ...
                <form className="relative mx-auto w-max">
                  <input type="search"
                    className="peer cursor-pointer relative z-10 h-9 w-full text-black rounded-full  bg-transparent outline-none focus:w-full focus:cursor-text focus:pl-16 focus:pr-4" />
