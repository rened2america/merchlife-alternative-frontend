...
const HowItWorks = () => {
  const Links = [
    { text: "HOME", href: "/" },
    { text: "TERMS OF USE", href: "#", icon: true },
  ];

  return (
    <>
      <div className={`${raleway.className}`}>
        <SubHeaderCard title="TERMS OF USE" links={Links} />
        <div className="mb-5 flex w-full flex-col bg-white p-4 text-center leading-normal">
          ...
          <div className=" mx-auto w-5/6 space-y-8 text-left text-sm font-normal text-gray-700 md:text-base lg:text-lg xl:mb-6 xl:text-xl">
            <p>
              This website is operated by D2America Inc.
              </p><p>
              Throughout the site, the terms &ldquo;we&rdquo;, &ldquo;us&rdquo; and
              &ldquo;our&rdquo; refer to Merchlife.
              </p><p>
              Merchlife.com offers this website, including all information, tools, and services
            ...
            <p>
              ...
              <br />A breach or violation of any of the Terms will result in immediate termination
              of your Services.
            </p>
            ...
            <p>
              ...
              website through which the service is provided, without express wrote permission by us.
              <br />
            ...
            <p>
              ...
              &ldquo;as available&rdquo; without any warranties, representations or conditions of
            ...
            <p>
              ...
              (collectively, 'comments'), you agree that we may, at any time, without restriction,
              edit, copy, publish, distribute, translate and otherwise use in any medium any
              comments that you forward to us. We are and shall be under no obligation (1) to
              maintain any comments in confidence; (2) to pay compensation for any comments; or (3)
            ...
            <p>
              ...
              non-infringement.
              <br />
              In no case shall merchlife.com, our directors, officers, employees, affiliates,
            ...
            <p>
              You agree to indemnify, defend and hold harmless Merchlife.co and our parent,
              ...
              harmless from any claim or demand, including reasonable attorneys&rsquo; fees, made by
            ...
            <p>
              ...
              shall be governed by and construed in accordance with the laws of 12 S 1St Street San
              Jose Alabama US 95113.
            </p>
            ...
            <p>
              Questions about the Terms of Service should be sent to us at support@merchlife.com
              <br />
            </p>
          </div>
        </div>
