                    ...
                    <tr key={product?.id} className="border-b-8 border-b-white bg-[#F3F3F3]">
                      <td className="px-5 py-4">
                        <div className="flex h-24 items-center">
                          <button className="" onClick={() => {removeFromCart(product?.name,product?.size,product?.url);console.log(product?.name,product?.size,product?.url);
                          }}>
                            <svg
                              width="47"
                              height="47"
                      ...
                      <td className="px-5 py-4">
                        <div className="border-r-gray flex h-24 items-center border-r-2 p-2">
                          <img
                            src={product?.url}
                            alt={product?.name}
