      ...
      <div className="relative h-screen sm:flex sm:flex-row justify-center bg-transparent rounded-3xl shadow-xl">
        ...
        <div className="flex justify-center self-center z-10 p-10 mt-12">
          <div className="p-12 bg-white mx-auto rounded-3xl w-full max-w-md sm:w-96">
            <div className="mb-7">
              <h3 className="font-semibold text-2xl text-gray-800">{APP_TITLE} Sign Up</h3>
              {/* <p className="text-gray-400">
                Already have an account?&nbsp;
                <Link href={"/login"} className="text-sm text-purple-700 hover:text-purple-700">
                  Login
                </Link>
              </p> */}
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="text-sm ml-auto">
                    <Link href={"/login"}>
                      <span className="p-0 text-xs font-medium underline-offset-4 text-purple-700 hover:text-purple-600">
